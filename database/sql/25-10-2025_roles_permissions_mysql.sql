...
SELECT CONCAT('Permisos insertados: ', COUNT(*)) as resultado FROM permissions;

-- Verificar que se insertaron todos los roles
SELECT CONCAT('Roles insertados: ', COUNT(*)) as resultado FROM roles;
...
SELECT CONCAT(u.nombre, ' ', u.apellido) as usuario, u.rol as rol_legacy, r.name as rol_nuevo
FROM usuarios u
