 ...
 * @route '/payment-methods/{payment_method}/edit'
 */
    const editForm = (args: { payment_method: string | number } | [payment_method: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/payment-methods/{payment_method}/edit'
 */
        editForm.get = (args: { payment_method: string | number } | [payment_method: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: edit.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/payment-methods/{payment_method}/edit'
 */
        editForm.head = (args: { payment_method: string | number } | [payment_method: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
